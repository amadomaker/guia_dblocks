var MSG = {
  ...
  en_introduction_text:
    "Primeiro precisamos instalar um driver para o computador/notebook reconhecer a placa através da conexão por cabo microusb. Baixe o driver CP210x através do link abaixo:",
  en_install_driver: "Instalar driver",
  en_found_download:
    "Procure por download ou transferência e baixe a versão indicada abaixo:",
  en_info_micropython:
    "Para programar a placa Amado board no dblocks precisamos instalar o micropython e vamos fazer issoatravés do link abaixo para facilitar a instalação.",
  en_install_micropython: "Instalar micropython",
  en_info_micropython_page:
    "<span style='color:red;'>Na página de instalação contém um vídeo tutorial ensinando todo o processo</span>, o site é bem simples e intuitivo, basta clicar em conectar, selecionar a porta USB conforme a imagem abaixo e instalar o Micropython, esse processo pode demorar uns 2 minutos ou mais.",
  en_acessing_plataform_title: "Acessando a plataforma",
  en_acessing_plataform_info1:
    "Na barra de pesquisa procure por dblocks e acesse o primeiro site ou acesse pelo link: dblocks.com.br",
  en_acessing_plataform_info2:
    "Na pagina inicial clique no botão “comece a programar”, logo após aparecerá uma mensagem de boas vindas com algumas informações, se já tiver feito a instalação do micropython pode fechar a mensagem, a sua placa já está pronta para uso, caso contrario clique em “Instalador Micropython e faça o processo”.",
  ...
  en_info_extra:
    "**Obs: Também é possivel baixar e recarregar a programação para usar quando quiser ou em outro computador.",
  en_first_project_title: "Primeiro projeto: Piscar um led infinitamente",
  en_first_project_step1:
    "Primeiro clique em Controle, depois em Laços e clique sobre o bloco “repita enquanto”, posicione conforme a sua vontade.",
  en_first_project_step2:
    "Logo após clique em váriaveis, Boleanas e selecione o bloco 'Verdadeiro'. Posicione o bloco encaixando no bloco anterior no bloco anterior conforme mostra a imagem abaixo:",
  en_first_project_step3:
    "Neste momento já temos o nosso loop que é responsável pela execução repetidamente do nosso programa, nesse caso fazer com que o nosso led piscar de forma infinita.",
  en_first_project_step4:
    "O próximo passo é usar os blocos responsáveis por acender e apagar o nosso led que podem ser encontrados na categoria Pinos entrada/saida. Procure pelo bloco 'ajustar pino de saida' e posicione dentro do loop. Teremos que adicionar o mesmo bloco duas vezes, um para acender e outro para apagar, no segundo bloco escolha a opção flaso em 'para'.",
  en_first_project_step5:
    "Também usaremos uma pausa para que o led permaneça aceso e apagado por um intervalo de tempo, procure pelo bloco 'esperar' em controle, selecionando a categoria Temporização. Posicione os blocos conforme a imagem abaixo mostra.",
  en_first_project_step6:
    "Agora que já montamos o programa, clique no botão de conectar na parte superior direito, selecione a porta(placa) conectada ao seu computador e clique em conectar.",
  en_first_project_step7:
    "Feito isso verá o ícone dessa forma sinalizando que a Amado board já está conectada a plataforma",
  en_first_project_step8:
    "Agora basta clicar no botão que executa o programa e verá o led embutido na placa piscando em intervalos de 1 segundo.",
  en_first_project_step9:
    "Observações: É possível executar e pausar o programa quantas vezes quiser clicando no mesmo botão.",
  en_first_project_step10:
    "Parabéns! Você acaba de criar o seu primeiro programa usando a Amado board na plataforma Dblocks.",

  //Página inOutDigital
  di_title: "Entrada e Saída Digital",
  di_introduction_title: "Introdução",
  di_intro1:
    'Em sistemas eletrônicos e de automação, as <strong>entradas digitais</strong> são sinais que o dispositivo recebe do ambiente. Esses sinais representam estados binários — geralmente "ligado" ou "desligado" (1 ou 0). Exemplos comuns incluem botões, sensores de presença e interruptores.',
  di_intro2:
    "Já as <strong>saídas digitais</strong> são os sinais que o dispositivo envia para atuar sobre o ambiente, também em forma binária. Com elas, é possível controlar LEDs, relés, motores e outros componentes que operam em dois estados (ligado/desligado).",
  di_intro3:
    "Esses conceitos são fundamentais em projetos de automação, onde sensores informam o estado do ambiente e atuadores respondem de acordo com a lógica definida.",
  di_intro4:
    "A seguir, vamos ver como utilizar entradas e saídas digitais na prática de forma simples e intuitiva.",

  //Entrada digital
  di_in_title: "Entrada Digital",
  di_in1:
    "Um exemplo prático de entrada digital pode ser feito com a plataforma <strong>dBlocks</strong> e a <strong>Amado Board</strong>.",
  di_in2:
    "Na imagem abaixo, temos um programa que realiza a leitura contínua de um pino digital da placa:",
  di_in3: "O que este programa faz?",
  di_in4:
    "<strong>Enquanto o programa estiver rodando</strong>, ele executa repetidamente as instruções dentro do bloco <code>repita enquanto verdadeiro</code>.",
  di_in5:
    "Ele <strong>lê o estado lógico</strong> (0 ou 1) do pino <strong>D16 / SERVO B</strong> usando o comando <code>ler entrada digital</code>.",
  di_in6:
    "O valor lido é <strong>armazenado na variável <code>x</code></strong>.",
  di_in7:
    "Em seguida, o programa <strong>imprime no console</strong> uma mensagem como: <code>Valor de x: 1</code> ou <code>Valor de x: 0</code>.",
  di_in8:
    "O programa então <strong>aguarda 500 milissegundos</strong> antes de repetir a leitura.",
  di_in9: "Montagem no hardware",
  di_in10:
    "Para testar esse código na prática, você pode utilizar um <strong>jumper</strong> conectado ao pino <code>D16</code> da Amado Board. Alterne esse jumper entre o <strong>GND</strong> (0V) e os <strong>3.3V</strong>, simulando assim um sinal digital:",
  di_in11:
    "Quando o jumper está no <strong>GND</strong>, o valor lido será <code>0</code>.",
  di_in12:
    "Quando o jumper está nos <strong>3.3V</strong>, o valor lido será <code>1</code>.",
  di_in13:
    "Isso demonstra claramente o funcionamento de uma entrada digital, mostrando como a placa interpreta dois estados distintos e como isso pode ser visualizado no console.",
  di_in14: "Visualização dos resultados no console",
  di_in15:
    "A plataforma dBlocks possui um console que permite acompanhar, em tempo real, o resultado das leituras feitas pelos blocos. No exemplo a seguir, vemos o valor da variável <code>x</code> sendo impresso continuamente:",
  di_in16:
  ...
  di_out1:
    'As saídas digitais permitem que a placa controle dispositivos externos, enviando sinais do tipo "ligado" ou "desligado". Um exemplo clássico é o controle de um LED.',
  di_out2:
    "Abaixo temos um exemplo onde o LED azul conectado ao pino <code>D2</code> da <strong>Amado Board</strong> pisca continuamente:",
  di_out3: "O que este programa faz?",
  di_out4:
    "O bloco <code>repita enquanto verdadeiro</code> garante que o programa fique executando em loop.",
  di_out5:
    "O pino <code>D2 / LED AZUL</code> é configurado como saída digital.",
  di_out6:
    "Primeiro, o LED é ligado com o comando <code>ajustar pino de saída para verdadeiro</code>.",
  di_out7: "O programa então aguarda <strong>500 milissegundos</strong>.",
  di_out8:
    "Depois, o LED é desligado com o comando <code>ajustar pino de saída para falso</code>.",
  di_out9:
    "Mais uma vez, o programa aguarda <strong>500 milissegundos</strong>.",
  di_out10:
    "Isso faz com que o LED pisque continuamente com um intervalo de meio segundo entre acender e apagar. Esse tipo de controle é muito útil em sistemas de sinalização, notificações visuais ou testes simples de funcionamento de pinos.",

  // Página inOutAnalog
  an_introduction_title: "Introdução",
  an_intro1:
    "Em projetos eletrônicos, as <strong>entradas e saídas analógicas</strong> permitem trabalhar com sinais que variam de forma contínua. Diferente dos sinais digitais que só têm dois estados (0 ou 1), os sinais analógicos podem representar uma faixa de valores, o que os torna ideais para medir grandezas como luminosidade, temperatura ou controlar intensidade de um LED.",
  an_intro2:
    "Neste exemplo, vamos utilizar o sensor de luz <strong>LDR</strong>, que já está embutido na <strong>Amado Board</strong>, como entrada analógica. E para a saída, vamos ajustar o brilho do LED interno da placa utilizando um sinal PWM.",
  an_intro3:
  ...
  an_in1:
    "Vamos fazer a leitura do sensor de luz LDR da placa ligando um jumper do terminal do LDR até o pino <code>39</code>, que é uma entrada analógica.",
  an_in2:
  ...
  an_in4:
    "Dentro do bloco <code>repita enquanto verdadeiro</code>, ele executa repetidamente as instruções.",
  an_in5:
    "O pino <code>39</code> é lido com o comando <code>ler entrada analógica</code>.",
  ...
  an_in8:
    "Há uma pausa de <strong>500 milissegundos</strong> antes da próxima leitura.",
  an_in9: "Visualização dos resultados",
  an_in10:
    "A cada variação da luminosidade ambiente, o valor da variável <code>valor_ldr</code> também varia. Isso pode ser observado no console da plataforma:",
  an_in11:
  ...
  an_out1:
    "Para controlar a intensidade de um LED, utilizamos a técnica chamada <strong>PWM (modulação por largura de pulso)</strong>. Na prática, ela permite simular um sinal analógico em um pino digital.",
  an_out2:
    "Abaixo temos um exemplo utilizando o bloco PWM para controlar o LED azul embutido da <strong>Amado Board</strong> conectado ao pino <code>D2</code>:",
  an_out3: "O que este programa faz?",
  an_out4:
    "O bloco <code>PWM</code> é usado dentro de um laço de repetição contínuo <code>repita enquanto verdadeiro</code>.",
  an_out5:
    "Ele define o <strong>pino D2 / LED AZUL</strong> como saída com sinal PWM.",
  an_out6:
    "A <strong>frequência</strong> foi configurada como <code>100 Hz</code>, o que indica quantos ciclos por segundo o sinal será enviado.",
  an_out7:
    "O <strong>ciclo de trabalho (duty cycle)</strong> foi ajustado para <code>512</code>, o que representa 50% de intensidade (em uma escala de 0 a 1023).",
  an_out8:
  ...
  var_intro1:
    "Em programação, <strong>variáveis</strong> são usadas para armazenar valores que podem mudar ao longo do tempo. Elas são essenciais para guardar informações, fazer cálculos, controlar sensores ou mesmo imprimir mensagens no console.",
  var_intro2:
    "Para criar uma variável, vá até a categoria <strong>Variáveis</strong> no menu lateral e clique em <strong>Criar variável...</strong>. Escolha um nome claro e significativo, pois isso evita erros e torna o programa mais fácil de entender.",
  var_intro3:
    "Após criada, sua variável aparecerá em <strong>Variáveis criadas</strong> e poderá ser usada nos blocos para definir, alterar ou acessar seu valor.",
  var_intro4: "Existem diferentes tipos de variáveis disponíveis:",
  var_type_bool:
    "<strong>Booleanas</strong>: representam verdadeiro ou falso. Úteis para verificações ou condições.",
  var_type_num:
    "<strong>Numéricas</strong>: armazenam números inteiros, decimais ou aleatórios, comuns em leituras de sensores e cálculos.",
  var_type_text:
    "<strong>Texto</strong>: armazenam frases ou palavras, ideais para mostrar mensagens ou nomes.",
  var_type_list:
    "<strong>Listas</strong>: armazenam vários valores em uma mesma variável. Muito útil para organizar dados.",
  var_use_robotics:
    "Na robótica, variáveis são muito utilizadas para armazenar leituras de sensores como temperatura, distância, luz, entre outros. Isso permite tomar decisões ou ajustar comportamentos com base nos dados do ambiente.",
  ...
  var_print_example_desc:
    "No exemplo abaixo, criamos duas variáveis: uma de texto chamada <code>nome</code> e outra numérica chamada <code>valor</code>. Depois, usamos o bloco <strong>imprime</strong> que está localizado na categoria Funções --> Texto para mostrar os valores no console.",
  var_print_console_desc:
    "O resultado aparece no console como mostra a imagem a seguir. Esse recurso é muito útil para acompanhar os valores de sensores durante a execução do programa.",
  //Seção Print
  print_section_title: 'Impressão com o bloco "imprime"',
  print_intro1:
    "A função de <strong>impressão</strong> permite acompanhar os valores durante a execução do programa. Isso é muito útil para verificar se os dados dos sensores ou variáveis estão corretos.",
  print_intro2:
    "Para usar, acesse a categoria <strong>Funções → Texto</strong> e selecione o bloco <code>imprime</code>. Ele pode ser usado para mostrar textos simples ou valores de variáveis.",
  ...
  loop_intro1:
    "Loops são estruturas que permitem executar um mesmo conjunto de comandos várias vezes. Eles são úteis para automatizar tarefas repetitivas, como contar, exibir mensagens, ou manipular listas.",
  loop_intro2:
    "Na plataforma, os blocos de repetição estão disponíveis na categoria <strong>Controle</strong> e incluem diferentes tipos de laços com finalidades variadas.",

  loop_repeat_times_title: "1. Repetição com número fixo",
  loop_repeat_times_desc:
    "O bloco <code>repita X vezes</code> executa o conjunto de comandos um número específico de vezes. Ideal para contagens simples ou ações repetidas.",
  loop_repeat_times_explanation:
    "Neste exemplo, usamos uma variável <code>contador</code> para contar até 5. A cada repetição, imprimimos o valor atual.",

  loop_repeat_while_title: "2. Repetição enquanto uma condição for verdadeira",
  loop_repeat_while_desc:
    "O bloco <code>repita enquanto</code> continua executando os comandos enquanto a condição definida for verdadeira.",
  loop_repeat_while_explanation:
    "Neste exemplo, a variável <code>numero</code> é incrementada até chegar a 5. O loop para quando a condição <code>numero < 5</code> não for mais verdadeira.",

  loop_count_title: "3. Repetição com contador personalizado",
  loop_count_desc:
    "O bloco <code>contar com i de X até Y por Z</code> permite maior controle sobre a repetição, incluindo o valor inicial, final e o passo.",
  loop_count_explanation:
    "Neste exemplo, imprimimos a tabuada do 2, multiplicando o valor de <code>i</code> a cada repetição.",

  loop_for_each_title: "4. Repetição para cada item de uma lista",
  loop_for_each_desc:
    "O bloco <code>para cada item na lista</code> percorre todos os elementos de uma lista. Ideal para processar ou exibir vários dados.",
  loop_for_each_explanation:
    "Aqui temos uma lista de nomes. O loop imprime um nome por vez até que todos sejam exibidos.",

  loop_break_title: "5. Encerrar laço com condição",
  loop_break_desc:
    "O bloco <code>encerra o laço</code> permite interromper a execução do loop antes de ele completar todas as repetições.",
  loop_break_explanation:
    "Neste exemplo, contamos de 1 até 10, mas encerramos o laço quando o contador atinge o valor 6.",
  loop_forever_title: "2. Repita enquanto verdadeiro",
  loop_forever_desc:
    "O bloco <code>repita enquanto verdadeiro</code> executa os comandos de forma contínua, sem parar. É muito usado em projetos de robótica, onde o programa precisa rodar constantemente enquanto o sistema estiver ligado.",
  loop_forever_explanation:
    "Neste exemplo, a variável <code>contador</code> é incrementada a cada segundo, e seu valor é impresso no console repetidamente.",

  var_loop_print_end:
    "Todos os resultados dos exemplos acima podem ser visto no console da plataforma.",
  ...
  sensor_intro2:
    "Na plataforma, os blocos relacionados a sensores estão disponíveis na categoria <strong>Sensores</strong>.",
  ...
  sensor_ir_desc2:
    "Este sensor possui <strong>3 pinos</strong> (VCC, GND e Sinal) e pode ser facilmente conectado à <strong>Amado Board</strong> usando os pinos de entrada digital, como <code>D34</code>, <code>D35</code>, <code>D36</code> e <code>D39</code>. A placa já possui espaço apropriado para o encaixe direto, tornando a montagem rápida e prática.",
  sensor_ir_desc3:
  ...
  sensor_dht_step3:
    "A cada repetição, a leitura da <strong>temperatura</strong> e da <strong>umidade</strong> é atualizada e armazenada em variáveis.",
  sensor_dht_step4:
    "Esses valores são exibidos no console usando o bloco <code>imprime</code>.",
  sensor_dht_step5:
    "Uma pausa de 1 segundo entre as leituras é muito importante para garantir o bom funcionamento do sensor.",
  //Sensor Ultrassônico
  ...
  sensor_ultra_desc2:
    "Na <strong>Amado Board</strong>, já existe um espaço próprio para encaixar esse sensor diretamente nos pinos <code>D17</code> (trigger) e <code>D34</code> (echo), facilitando sua conexão e uso em projetos de robótica.",
  ...
  sensor_ultra_step2:
    "Usamos um <strong>loop contínuo</strong> para medir a distância constantemente.",
  sensor_ultra_step3:
  ...
  sensor_rfid_map7:
    "SDA (do módulo) deve ser conectado ao CS no bloco, recomendado usar D5 como na imagem.",
  sensor_rfid_desc4:
  ...
  rfid_libraries_desc:
    "Para que os blocos do leitor RFID RC522 funcionem corretamente, é necessário instalar a biblioteca <code>mfrc522</code>, que permite a comunicação e leitura de cartões RFID.",
  rfid_verify_library:
    "Após clicar no botão <strong>“Instalar biblioteca”</strong>, você pode verificar a instalação pela mensagem no console: <code>Instalação da biblioteca mfrc522 concluída.</code>",
  rfid_verify_file:
    "Também é possível confirmar a presença da biblioteca abrindo a aba <strong>Arquivos</strong>. Clique duas vezes no botão de atualizar e verifique se o arquivo <code>mfrc522.py</code> aparece listado na memória da placa.",
  sensor_rfid_desc6:
  ...
  actuator_intro3:
    "Na plataforma, os blocos de atuadores estão disponíveis na categoria <strong>Saídas e Atuadores</strong>. Cada tipo de atuador terá seus próprios blocos com comandos específicos.",
  ...
  relay_example_note:
    "Esse exemplo simples de temporizador também poderia ser usado dentro de uma <strong>condição</strong> (por exemplo, ao detectar um cartão RFID, presença, horário, etc.) para tomar decisões automáticas no programa.",
  ...
  servo_smooth_desc:
    "Neste exemplo usamos um <strong>laço for</strong> para movimentar suavemente o servo de 0° até 180° e voltar. Isso cria um movimento fluido e contínuo, útil para simulações de radar, varredura ou movimentos controlados em braço robótico.",
  ...
  servo_ultra_desc:
    "Aqui combinamos o servo com um <strong>sensor ultrassônico</strong> para simular uma <strong>porta automática</strong> ou cancela de shopping. Se a distância for menor que 100mm, o servo abre a porta (ângulo 90°). Caso contrário, ela permanece fechada (ângulo 0°).",
  servo_ultra_tip:
    "A comparação é feita com o bloco <code>se</code> que pode ser expandido com a opção <code>senão</code>, ativada pela engrenagem do bloco. A operação <code><</code> usada na condição está disponível na categoria <strong>Matemática → Lógica</strong>.",
  ...
  motor_desc2:
    "Na plataforma, controlamos o motor DC usando três pinos: <strong>PWM</strong> para a potência (velocidade) e <strong>DIR1</strong> e <strong>DIR2</strong> para a direção. O bloco <code>Iniciar motor DC</code> permite selecionar os pinos e dar um <strong>nome personalizado</strong> ao motor, como motor1, motor2, etc. Isso permite controlar vários motores de forma independente.",
  motor_desc3:
    "A <strong>Amado Board</strong> já possui um espaço físico apropriado com bornes de parafuso azuis nas laterais da placa, facilitando a ligação de até dois motores diretamente. Esses bornes estão conectados aos pinos PWM, DIR1 e DIR2 da placa.",
  motor_desc4:
  ...
  motor_example_desc:
    "O exemplo abaixo demonstra o uso básico do motor DC alternando sua direção. O motor gira para um lado por alguns segundos, para, depois gira para o outro lado.",
  ...
  buzzer_intro1:
    "A campainha, também conhecida como buzzer, é um atuador que emite sons simples ou melodias. Pode ser utilizada para alarmes, avisos sonoros, confirmações de eventos ou até mesmo para tocar músicas temáticas. A Amado Board já possui um buzzer integrado conectado ao pino D4, que pode ser usado diretamente.",
  ...
  buzzer_verify_library:
    "Após clicar no botão “Instalar biblioteca”, você pode verificar a instalação pela mensagem no console: Instalação da biblioteca rtttl concluída.",
  buzzer_verify_file:
    "Também é possível confirmar a presença da biblioteca abrindo a aba Arquivos. Clique duas vezes no botão de atualizar e verifique se o arquivo rtttl.py e songs.py aparece listado na memória da placa.",

  buzzer_block_freq_title: "1. Reproduzir som por frequência",
  buzzer_block_freq_desc:
    "Este bloco permite gerar um som especificando uma frequência (em Hertz) e uma duração (em segundos). Por exemplo, 1000 Hz gera um som agudo. Se você usar 0 ou -1 como tempo, o som será contínuo até que outro comando seja executado.",
  ...
  display_intro1:
    "O display OLED SSD1306 é uma tela de pequeno porte com comunicação I2C, muito utilizada em projetos de eletrônica e robótica para exibir informações como textos, valores de sensores ou mensagens do sistema.",
  display_intro2:
    "Na plataforma, os blocos para controle do display estão localizados na categoria Telas. Antes de utilizá-lo, é necessário instalar a biblioteca ssd1306 clicando no bloco Instalar biblioteca: ssd1306.",
  display_connection_info:
    "A Amado Board possui um espaço dedicado para conexão do display, identificado na própria placa com o nome OLED DISPLAY. Esse conector utiliza comunicação I2C, e os pinos correspondentes são: SDA no pino D21 e SCL no pino D22. Basta encaixar o módulo OLED no local correto e iniciar a comunicação com esses pinos no bloco de inicialização.",
  display_blocks_info:
    "Para que o texto ou valor apareça corretamente na tela, é fundamental seguir a ordem correta dos blocos: 1) limpar o display, 2) escrever o conteúdo (mensagem ou número) e 3) atualizar o display. O bloco de atualização envia de fato o conteúdo para o display, sem ele nada será mostrado.",

  display_example1_title: "Exemplo 1: Escrever texto fixo no display",
  display_example1_desc:
    "Neste exemplo, mostramos como posicionar um texto estático na tela usando os blocos adequados. Esse é o primeiro passo para qualquer projeto com o display.",
  display_example1_steps: "O que esse programa faz?",
  display_example1_step1:
    "Inicializa o display com os pinos corretos (I2C: 1, SCL: 22, SDA: 21).",
  display_example1_step2:
    "Limpa o display para garantir que não haja resíduos de texto anterior.",
  display_example1_step3:
    'Escreve o texto "Hello" na posição desejada da tela.',
  ...
  display_example3_desc:
    "Este exemplo demonstra como criar um contador que é atualizado constantemente no display. Ideal para aprender a manipular variáveis visuais.",
  display_example3_steps: "O que esse programa faz?",
  display_example3_step1: "Inicializa o display.",
  display_example3_step2:
    "Cria uma variável que aumenta de valor a cada segundo.",
  display_example3_step3:
    "Limpa o display, exibe o valor da variável e atualiza a tela continuamente.",

  display_example4_title: "Exemplo 3: Mostrar valor do sensor LDR",
  display_example4_desc:
    "Aqui mostramos como integrar o display com sensores. Neste caso, exibimos o valor da luminosidade lido por um sensor LDR.",
  display_example4_steps: "O que esse programa faz?",
  display_example4_step1:
    "Inicializa o display e configura a leitura do sensor LDR.",
  display_example4_step2: "Lê continuamente o valor de luminosidade ambiente.",
  display_example4_step3:
    "Mostra o valor na tela, atualizando a cada 500 milissegundos.",
...
bluetooth_section_title: "Comunicação via Bluetooth (BLE)",
bluetooth_intro: "O Bluetooth é uma tecnologia de comunicação sem fio de curto alcance, usada em celulares, fones de ouvido, computadores, carros e sistemas embarcados. Ele permite a troca de dados entre dispositivos próximos, de forma simples e sem cabos.",
bluetooth_ble_reason: "Neste projeto utilizamos o padrão BLE (Bluetooth Low Energy), que é o único suportado pelo MicroPython no ESP32. Ele é ideal para sistemas com sensores, comandos remotos, automação e monitoramento com baixo consumo de energia.",
bluetooth_project_ideas: "Com o BLE, é possível criar projetos como: controle remoto de robôs, envio de dados de sensores para o celular, gráficos de monitoramento em tempo real, automação residencial, sistemas de alarme e até jogos interativos usando botões virtuais.",
bluetooth_blocks_title: "Blocos disponíveis para comunicação Bluetooth",
bluetooth_blocks_intro: "Os blocos de Bluetooth estão disponíveis na aba Comunicação → Bluetooth. Para o funcionamento do código, é necessário instalar a biblioteca ble_advertising clicando no botão indicado na interface.",
bluetooth_block1: "<strong>Configura e inicia o Bluetooth com o nome:</strong> define o nome do dispositivo BLE visível no celular.",
bluetooth_block2: "<strong>Definir os dados recebidos via bluetooth para:</strong> armazena os dados enviados pelo aplicativo em uma variável.",
bluetooth_block3: "<strong>Verificar os dados recebidos:</strong> interpreta os comandos recebidos.",
bluetooth_block4: "<strong>Configurar o plotador para sensores:</strong> permite definir qual sensor será visualizado em gráfico no app.",
bluetooth_block5: "<strong>Enviar dados para o plotador:</strong> envia valores da aplicação para o gráfico do aplicativo.",
bluetooth_program_title: "Programa base de comunicação Bluetooth",
bluetooth_tip_execution: "Este é o programa base mais simples e o principal ponto de partida. Com ele, já conseguimos testar se os dados estão chegando do celular para a placa.",
bluetooth_program_steps: "<strong>O que esse programa faz?</strong>",
bluetooth_step1: "Inicializa o BLE com o nome meuBluetooth.",
bluetooth_step2: "Cria a variável dados que recebe os comandos do celular.",
bluetooth_step3: "Verifica continuamente os dados recebidos e os interpreta com base no valor recebido.",
bluetooth_connected_tip: "Após montar, clique em Play e abra a aba Console. A mensagem “Conectado” indicará que o Bluetooth está funcionando corretamente.",
bluetooth_app_title: "Aplicativo Bluefruit Connect",
bluetooth_app_description: "Para interagir com o programa, usamos o app Bluefruit Connect da Adafruit. Ele está disponível gratuitamente para Android e iOS. Procure por “Bluefruit Connect” na loja de aplicativos, instale e abra.",
bluetooth_app_guide: "<strong>No aplicativo, siga os passos abaixo:</strong>",
bluetooth_app_step1: "Abra o app e selecione o dispositivo chamado MPY ESP32. Mesmo que você tenha definido outro nome no bloco, esse nome pode aparecer como padrão.",
bluetooth_app_step2: "Acesse a aba Controller e toque em Control Pad.",
bluetooth_app_step3: "Use os botões direcionais ou numéricos para enviar comandos para a placa.",
bluetooth_console_title: "Testando os botões no console",
bluetooth_console_info: "Após se conectar ao dispositivo e abrir o Control Pad, pressione os botões do app. No console da IDE, aparecerão mensagens como: Dados recebidos: !B507.",
bluetooth_console_example: "No nosso teste, usamos os botões de seta (cima, baixo, esquerda e direita). Para cada botão, o app envia dois comandos: um ao pressionar e outro ao soltar. Isso permite que o programa saiba quando o botão foi apertado e quando foi liberado.",
bluetooth_example2_title: "Acender LEDs integrados via Bluetooth",
bluetooth_example2_intro: "Neste exemplo, vamos controlar dois LEDs integrados da placa através do aplicativo. Quando o botão 1 for pressionado, o LED azul (pino D2) acenderá. Quando o botão 2 for pressionado, o LED verde (pino D33) será ativado.",
bluetooth_example2_behavior: "O comportamento é simples: enquanto o botão estiver pressionado no aplicativo, o LED correspondente permanece aceso. Ao soltar o botão, o LED apaga imediatamente.",
bluetooth_example2_usecase: "Essa lógica pode ser aplicada para acionar qualquer outro dispositivo: motores, robôs, sirenes, relés e mais. Aqui usamos LEDs apenas como exemplo visual e prático para facilitar o aprendizado.",
bluetooth_example2_speed: "Uma das vantagens impressionantes do BLE é a velocidade de resposta. A comunicação entre o app e a placa é praticamente instantânea, o que permite criar interações em tempo real sem atrasos visíveis.",
bluetooth_example2_codeinfo: "O programa base continua o mesmo do exemplo anterior, mas agora adicionamos condições se para verificar os dados recebidos e controlar os LEDs com base neles.",
bluetooth_example2_logic: "O código verifica se a variável dados contém o valor correspondente aos botões pressionados no aplicativo:",
bluetooth_example2_if1: "Se dados = \"!B11\", o LED azul (pino D2) acende.",
bluetooth_example2_if2: "Se dados = \"!B19\", o LED verde (pino D33) acende.",
bluetooth_example2_else: "Se nenhum desses valores for detectado (ou se o botão for solto), os LEDs são apagados.",
bluetooth_example3_title: "Enviando dados de sensores para o gráfico do app",
bluetooth_example3_intro: "O aplicativo Bluefruit Connect oferece um recurso chamado Plotter, que permite visualizar dados em tempo real em forma de gráfico. Esse recurso é ideal para monitorar sensores analógicos, como temperatura, luminosidade (LDR), umidade, entre outros.",
bluetooth_example3_utility: "Essa ferramenta é muito útil para interpretar o comportamento de sensores ao longo do tempo. Ao ver as variações graficamente, conseguimos identificar picos, quedas e padrões de forma mais clara do que apenas olhando valores no console.",
bluetooth_example3_goal: "Neste exemplo, vamos usar o sensor de luminosidade (LDR) integrado à placa, conectado ao pino D39, para enviar valores via Bluetooth e visualizá-los em tempo real no gráfico.",
bluetooth_example3_plotter_config_tip: "Ao clicar na engrenagem azul do bloco “Configurar o plotador para sensores”, é possível adicionar mais campos para enviar até 3 valores diferentes ao gráfico, como temperatura, umidade ou outros sensores.",
bluetooth_example3_plotter_limit: "O aplicativo Bluefruit Connect suporta até 3 gráficos simultâneos, facilitando a análise de múltiplos sensores ao mesmo tempo.",
bluetooth_example3_code_explained: "O que esse programa faz?",
bluetooth_example3_step1: "Inicializa o Bluetooth e configura o plotador com o nome do sensor.",
bluetooth_example3_step2: "Lê continuamente o valor do sensor LDR no pino D39.",
bluetooth_example3_step3: "Exibe esse valor no console e também envia para o gráfico no app.",
bluetooth_example3_step4: "Repete esse processo a cada 1 segundo.",
bluetooth_example3_plotter_title: "Acessando o gráfico no app",
bluetooth_example3_plotter_access: "Após rodar o programa e conectar ao dispositivo, clique na opção Plotter no aplicativo Bluefruit Connect.",
bluetooth_example3_result_title: "Visualizando os resultados no gráfico",
bluetooth_example3_result_info: "No gráfico, é possível acompanhar a variação do valor do sensor em tempo real. A linha se movimenta conforme a luminosidade muda — ao cobrir o sensor, o valor diminui; ao iluminar, o valor aumenta.",
bluetooth_example3_plotter_controls: "O Plotter também possui controles na parte inferior:",
bluetooth_example3_autoscroll: "AutoScroll: quando ativado, o gráfico rola automaticamente à medida que novos dados chegam.",
bluetooth_example3_width: "Width: ajusta a largura da linha no gráfico, útil para destacar picos ou suavizar curvas.",

//Keywords para busca
kw_introduction: "introdução",
kw_beginners: "iniciantes",
kw_block_programming: "programação em blocos",
kw_dblocks_basics: "dblocks básico",
kw_interactive_projects: "projetos interativos",
kw_amadoboard: "amadoboard",
kw_hardware: "hardware",
kw_board_features: "características da placa",
kw_esp32_board: "placa esp32",
kw_pinout: "pinagem",
kw_environment_setup: "configuração de ambiente",
kw_drivers: "drivers",
kw_micropython_install: "instalar micropython",
kw_amadoboard_config: "configuração amadoboard",
kw_variables: "variáveis",
kw_loops: "loops",
kw_print_console: "imprimir no console",
kw_control_structures: "estruturas de controle",
kw_programming_fundamentals: "fundamentos de programação",
kw_logic_operators: "operadores lógicos",
kw_math_operators: "operadores matemáticos",
kw_boolean_logic: "lógica booleana",
kw_conditional_statements: "condicionais",
kw_digital_io: "e/s digital",
kw_digital_input: "entrada digital",
kw_digital_output: "saída digital",
kw_gpio: "gpio",
kw_led_control: "controle de led",
kw_analog_io: "e/s analógica",
kw_analog_input: "entrada analógica",
kw_analog_output: "saída analógica",
kw_adc: "adc",
kw_pwm_control: "controle pwm",
kw_sensors_dblocks: "sensores dblocks",
kw_data_collection: "coleta de dados",
kw_environment_monitoring: "monitoramento ambiental",
kw_sensor_integration: "integração de sensor",
kw_ldr: "ldr",
kw_dht11: "dht11",
kw_actuators_dblocks: "atuadores dblocks",
kw_device_control: "controle de dispositivo",
kw_motors_control: "controle de motor",
kw_servo_motor: "servo motor",
kw_relay_module: "módulo relé",
kw_music_dblocks: "música dblocks",
kw_sound_programming: "programação de som",
kw_melody_composition: "composição de melodia",
kw_buzzer_control: "controle de buzzer",
kw_display_dblocks: "display dblocks",
kw_oled_display: "display oled",
kw_text_on_display: "texto no display",
kw_show_sensor_data: "mostrar dados de sensor",
kw_dblocks_resources: "recursos dblocks",
kw_dblocks_features: "funcionalidades dblocks",
kw_advanced_features: "recursos avançados",
kw_project_development: "desenvolvimento de projeto",
//Keywords bluetooth
kw_bluetooth: "bluetooth",
kw_ble: "bluetooth low energy",
kw_bluetooth_esp32: "bluetooth esp32",
kw_ble_esp32: "ble esp32",
kw_bluetooth_control: "controle via bluetooth",
kw_bluetooth_communication: "comunicação bluetooth",
kw_bluetooth_projects: "projetos com bluetooth",
kw_ble_projects: "projetos com ble",
kw_app_integration: "integração com aplicativo",
kw_bluefruit_app: "aplicativo bluefruit",
kw_data_plotting: "visualização de dados",
kw_graph_plotting: "gráfico de dados",
kw_remote_control: "controle remoto",
kw_realtime_data: "dados em tempo real",
...
kw_interactive_control: "controle interativo",
kw_wireless_control: "controle sem fio"
