var MSG = {
  ...
  complete_amadoboard_guide: " AmadoBoard Quick Guide",
  ...
  kw_bluetooth_control: "bluetooth control",
  kw_bluetooth_communication: "bluetooth communication",
  kw_bluetooth_projects: "bluetooth projects",
  kw_ble_projects: "ble projects",
  kw_app_integration: "app integration",
  kw_bluefruit_app: "bluefruit app",
  kw_data_plotting: "data visualization",
  kw_graph_plotting: "data plotting",
  kw_remote_control: "remote control",
  kw_realtime_data: "real-time data",
  kw_control_pad: "control pad",
  kw_bluetooth_plotter: "bluetooth plotter",
  kw_bluetooth_graphs: "bluetooth graphs",
  kw_bluetooth_sensors: "bluetooth sensors",
  kw_interactive_control: "interactive control",
  kw_wireless_control: "wireless control",

  display_section_title: "OLED SSD1306 Display",
  display_intro1:
    "The OLED SSD1306 display is a small screen with I2C communication, widely used in electronics and robotics projects to show information such as text, sensor values, or system messages.",
  display_intro2:
    "On the platform, the blocks for controlling the display are found in the Screens category. Before using it, you must install the ssd1306 library by clicking the Install library: ssd1306 block.",
  display_connection_info:
    "The Amado Board has a dedicated slot for connecting the display, identified on the board as OLED DISPLAY. This connector uses I2C communication, with SDA on pin D21 and SCL on pin D22. Just plug the OLED module into the correct place and start communication using those pins in the initialization block.",
  display_blocks_info:
    "For the text or value to appear correctly on the screen, it is essential to follow the correct block sequence: 1) clear the display, 2) write the content (message or number), and 3) update the display. The update block actually sends the content to the screen; without it, nothing will be shown.",

  display_example1_title: "Example 1: Display fixed text on screen",
  display_example1_desc:
    "In this example, we show how to position a static text on the screen using the appropriate blocks. This is the first step in any display project.",
  display_example1_steps: "What does this program do?",
  display_example1_step1:
    "Initializes the display with the correct pins (I2C: 1, SCL: 22, SDA: 21).",
  display_example1_step2:
    "Clears the display to ensure there are no previous text residues.",
  display_example1_step3:
    'Writes the text "Hello" at the desired position on the screen.',
  ...
  display_example3_desc:
    "This example demonstrates how to create a counter that is constantly updated on the display. Great for learning how to visually manage variables.",
  display_example3_steps: "What does this program do?",
  display_example3_step1: "Initializes the display.",
  display_example3_step2:
    "Creates a variable that increases in value every second.",
  display_example3_step3:
    "Clears the display, shows the variable value, and continuously updates the screen.",

  display_example4_title: "Example 3: Display LDR sensor value",
  display_example4_desc:
    "Here we show how to integrate the display with sensors. In this case, we display the brightness value read by an LDR sensor.",
  display_example4_steps: "What does this program do?",
  display_example4_step1:
    "Initializes the display and sets up the LDR sensor reading.",
  display_example4_step2: "Continuously reads the ambient brightness value.",
  display_example4_step3:
    "Displays the value on the screen, updating every 500 milliseconds.",

  // Logic and Math
  logic_math_intro_title: "Logic and Math",
  logic_math_intro1:
    "Logic and math blocks are fundamental in programming. They allow you to create conditions, perform calculations, compare values, and make decisions. They are present in virtually all types of projects — from sensor readings to motor control and rule-based actions.",
  logic_math_intro2:
    "The Math category contains operations such as addition, subtraction, multiplication, division, rounding, square root, sine, value mapping, and more. The Logic category offers comparators (such as =, <, >), logical operators (AND, OR), and decision blocks like if, else, and else if.",

  logic_math_example1_title:
  ...
  logic_math_example1_step3:
    "If true, prints 'Greater than 10'; otherwise, prints 'Less than or equal to 10'.",
  logic_math_example1_console:
    "The test results are displayed in the platform's console. To view, click the Console tab at the top of the screen after running the program.",

  logic_math_example2_title: "Example 2: Convert analog value to percentage",
  logic_math_example2_desc:
    "In this example, we ask the user to enter a numeric value in the console to simulate a sensor reading. Then, we use the map block from the Math category, which converts a value from one range to another. This block is very useful in robotics projects to transform sensor readings (such as light, distance, or temperature) into more understandable scales like percentages. This helps in making decisions or displaying data to the user.",
  logic_math_example2_steps: "What does this program do?",
  logic_math_example2_step1:
    "Asks the user to enter a numeric value to simulate an analog reading.",
  logic_math_example2_step2:
    "Converts the value to a percentage using the map block.",
  logic_math_example2_step3:
    "Prints the converted value (in %) to the console.",
  logic_math_example2_console:
    "The number is entered directly in the console, located at the top of the screen. The converted value is then displayed for real-time monitoring.",

  logic_math_example3_title:
    "Example 3: Ventilation control using AND, OR, and else",
  logic_math_example3_desc:
    "In this example, we simulate the logic of a smart ventilation system that considers both temperature and humidity levels. We use logical operators AND and OR along with conditional blocks if and else if to define the system behavior based on values.",
  logic_math_example3_steps: "What does this program do?",
  logic_math_example3_step1:
    "Creates two variables with fixed values for temperature and humidity.",
  logic_math_example3_step2:
    "If temperature > 30 AND humidity > 70, prints 'Turn on fan and dehumidifier'.",
  logic_math_example3_step3:
    "Else if temperature > 30 OR humidity > 70, prints 'Turn on fan only'.",
  logic_math_example3_step4: "Else, prints 'Comfortable environment'.",
  logic_math_example3_console:
    "The decision results are shown in the console, allowing you to follow the logical behavior of the program.",
  logic_math_example3_tip:
    "You can change the values of the temperature and humidity variables to see how the program's behavior changes. This helps better understand the use of combined conditions and logical operators in real scenarios.",
  ...
  music_extra_info:
    "If you right-click on the melody block, you will see useful options such as Delete or Export that individual melody.",

  music_example3_title: "Example: “Happy Birthday” Melody",
  music_example3_desc:
    "In this example, we create a simple version of the 'Happy Birthday' melody using the platform’s music editor. This is a great way to practice composition, work with rhythm, and test playback with the buzzer.",
  music_example3_notes:
    "The notes used, in order, are: C4, C4, D4, C4, F4, E4 / C4, C4, D4, C4, G4, F4. Each group represents a musical phrase, and you can continue composing the next parts of the song in the same way.",
  music_example3_bpm:
    "Note that the BPM was set to 130, which makes the song a bit faster. You can try different BPM values to adjust the melody speed as you prefer.",
  music_example3_tips:
    "This type of exercise helps you understand how timing and pauses affect music playback. It also allows you to practice organizing notes on the piano roll and explore creative possibilities.",
  ...
  resources_intro:
    "In this section, we will present some extra features of the platform that can facilitate the use and organization of your projects. These details are often overlooked, but they make the experience with the environment even more efficient.",

  resources_project_block_title: "Project Data Block",
  resources_project_block_desc:
    "Whenever a new project is created, the Project Data block appears automatically. It is very useful as it allows you to fill in the author's name, the project ID (if integrated with IoT), and a custom description. This description is used as the filename when you export the project, making it easier to identify on your computer.",
  resources_project_block_info:
    "You can also find this block under Functions → Bipes and manually insert it into your project if needed.",

  resources_mult_projects_title: "Working with multiple projects",
  resources_mult_projects_desc:
    "At the top of the platform there is a user button (profile icon). Clicking on it opens a side panel with project management options.",
  resources_mult_projects_usage:
    "You can create multiple projects by clicking the + button and switch between them quickly. This feature is great for organizing different tasks, drafts, or code versions.",
  resources_mult_projects_lang_title: "Platform language",
  resources_mult_projects_lang:
    "In this panel, you can also change the interface language, choosing between Portuguese, English, or Spanish. This option appears at the bottom of the panel.",

  resources_topbar_title: "Other top bar buttons",
  resources_topbar_desc:
    "In addition to project management, the top bar includes several other useful buttons:",
  resources_topbar_item_python:
    "<strong>Python (icon)</strong>: opens the MicroPython installation page for your board.",
  resources_topbar_item_download:
    "<strong>Download</strong>: downloads the project code in <code>.xml</code> format.",
  resources_topbar_item_upload:
    "<strong>Upload</strong>: allows loading a previously saved <code>.xml</code> file.",
  resources_topbar_item_connect:
    "<strong>Connect</strong>: USB icon button to connect the board to the platform.",
  resources_topbar_item_play:
    "<strong>Play</strong>: runs the program loaded on the board.",

  resources_save_title: "Save the program to the board (main.py)",
  resources_save_intro:
    "One of the most important features of the platform is the ability to save the program directly to the board's memory, allowing it to run automatically whenever the board is powered on. This is done by saving the code with the name main.py.",
  resources_save_context:
    "To do this, you need to use the Files tab, which works as an internal file manager for the board. This feature is a differential of the platform, as it allows you to save, edit, delete, and run files directly from the device’s internal memory.",
  resources_save_steps:
    "Follow the steps below to save your program as 'main.py':",
  resources_save_check:
    "After saving, double-click the refresh button to update the board’s file list. You will see the new main.py file with the run at boot label, indicating that this will be the program automatically executed when the board is powered on.",
  resources_save_edit:
    "In addition to saving, you can edit or delete files directly from this tab. To delete main.py, simply click the trash icon next to the file name.",
  resources_save_tip: "Important note",
  resources_save_note:
    "In some cases, the program may continue running even after clicking Stop. If this happens, click the disconnect icon, press the board’s reset button, and reconnect. The play icon should reappear, allowing you to access the board’s memory again.",
  resources_save_note2:
    "This behavior is common when you want to delete <code>main.py</code> or return to normal usage with the platform. Whenever you finish a project and want to use it with an external power source, save it as <code>main.py</code>.",

  resources_save_step1:
    "Make sure the <strong>board is connected</strong> and <strong>no program is running</strong> (the <code>Play</code> button must be visible).",
  resources_save_step2: "Go to the <strong>Files</strong> tab.",
  resources_save_step3:
    'In the "Blocks for code" section, click <code>code.bipes.py</code> to view your program.',
  resources_save_step4:
    "Rename the file by clicking on <strong>code.bipes.py</strong> at the top of the editor and changing it to <code>main.py</code>.",
  ...
  resources_save_step3:
    'In the "Blocks to code" section, click <code>code.bipes.py</code> to view your program.',
  resources_save_step4:
  ...
  bluetooth_section_title: "Communication via Bluetooth (BLE)",
  bluetooth_intro: "Bluetooth is a short-range wireless communication technology used in phones, headphones, computers, cars, and embedded systems. It enables data exchange between nearby devices easily and wirelessly.",
  bluetooth_ble_reason: "In this project, we use the BLE (Bluetooth Low Energy) standard, which is the only one supported by MicroPython on the ESP32. It's ideal for systems with sensors, remote controls, automation, and monitoring with low power consumption.",
  bluetooth_project_ideas: "With BLE, you can create projects such as: remote control of robots, sending sensor data to the phone, real-time monitoring graphs, home automation, alarm systems, and even interactive games using virtual buttons.",
  bluetooth_blocks_title: "Blocks available for Bluetooth communication",
  bluetooth_blocks_intro: "The Bluetooth blocks are available under the Communication → Bluetooth category. For the code to work, you need to install the ble_advertising library by clicking the indicated button in the interface.",
  bluetooth_block1: "<strong>Configure and start Bluetooth with name:</strong> sets the BLE device name visible on the phone.",
  bluetooth_block2: "<strong>Set data received via Bluetooth to:</strong> stores data sent by the app in a variable.",
  bluetooth_block3: "<strong>Check received data:</strong> interprets the received commands.",
  bluetooth_block4: "<strong>Configure plotter for sensors:</strong> sets which sensor will be visualized in a graph in the app.",
  bluetooth_block5: "<strong>Send data to plotter:</strong> sends application values to the app's graph.",
  bluetooth_program_title: "Base program for Bluetooth communication",
  bluetooth_tip_execution: "This is the simplest and main starting point program. With it, we can already test if the data is reaching the board from the phone.",
  bluetooth_program_steps: "<strong>What does this program do?</strong>",
  bluetooth_step1: "Initializes BLE with the name meuBluetooth.",
  bluetooth_step2: "Creates the variable dados to receive the commands from the phone.",
  bluetooth_step3: "Continuously checks the received data and interprets it based on the received value.",
  bluetooth_connected_tip: "After assembling, click Play and open the Console tab. The message “Connected” will indicate that Bluetooth is working correctly.",
  bluetooth_app_title: "Bluefruit Connect App",
  bluetooth_app_description: "To interact with the program, we use the Bluefruit Connect app by Adafruit. It’s available for free for Android and iOS. Search for “Bluefruit Connect” in the app store, install, and open it.",
  bluetooth_app_guide: "<strong>In the app, follow the steps below:</strong>",
  bluetooth_app_step1: "Open the app and select the device called MPY ESP32. Even if you’ve defined another name in the block, this default name may appear.",
  bluetooth_app_step2: "Go to the Controller tab and tap Control Pad.",
  bluetooth_app_step3: "Use the directional or numeric buttons to send commands to the board.",
  bluetooth_console_title: "Testing buttons in the console",
  bluetooth_console_info: "After connecting to the device and opening the Control Pad, press the app’s buttons. Messages like: Data received: !B507 will appear in the IDE console.",
  bluetooth_console_example: "In our test, we used arrow buttons (up, down, left, right). For each button, the app sends two commands: one when pressed and another when released. This allows the program to know when the button was pressed and when it was released.",
  bluetooth_example2_title: "Turning on integrated LEDs via Bluetooth",
  bluetooth_example2_intro: "In this example, we’ll control two integrated LEDs on the board through the app. When button 1 is pressed, the blue LED (pin D2) turns on. When button 2 is pressed, the green LED (pin D33) activates.",
  bluetooth_example2_behavior: "The behavior is simple: while the button is pressed in the app, the corresponding LED stays on. When released, the LED immediately turns off.",
  bluetooth_example2_usecase: "This logic can be applied to control any device: motors, robots, sirens, relays, and more. Here, we use LEDs just as a visual and practical example to ease learning.",
  bluetooth_example2_speed: "One impressive advantage of BLE is the response speed. The communication between the app and the board is almost instant, allowing real-time interactions with no visible delays.",
  bluetooth_example2_codeinfo: "The base program remains the same as the previous example, but now we add <code>if</code> conditions to check the received data and control the LEDs accordingly.",
  bluetooth_example2_logic: "The code checks if the variable dados contains the value corresponding to the buttons pressed in the app:",
  bluetooth_example2_if1: "If dados = \"!B11\", the blue LED (pin D2) turns on.",
  bluetooth_example2_if2: "If dados = \"!B19\", the green LED (pin D33) turns on.",
  bluetooth_example2_else: "If none of these values are detected (or the button is released), the LEDs are turned off.",
  bluetooth_example3_title: "Sending sensor data to the app graph",
  bluetooth_example3_intro: "The Bluefruit Connect app offers a feature called Plotter that allows you to view data in real time as a graph. This feature is ideal for monitoring analog sensors such as temperature, light (LDR), humidity, and more.",
  bluetooth_example3_utility: "This tool is very useful for interpreting sensor behavior over time. By seeing variations graphically, we can identify spikes, drops, and patterns more clearly than just reading console values.",
  bluetooth_example3_goal: "In this example, we’ll use the onboard light sensor (LDR), connected to pin D39, to send values via Bluetooth and view them in real-time on the graph.",
  bluetooth_example3_plotter_config_tip: "By clicking the blue gear icon on the “Configure plotter for sensors” block, you can add more fields to send up to 3 different values to the graph, such as temperature, humidity, or other sensors.",
  bluetooth_example3_plotter_limit: "The Bluefruit Connect app supports up to 3 simultaneous graphs, making it easier to analyze multiple sensors at once.",
  bluetooth_example3_code_explained: "What does this program do?",
  bluetooth_example3_step1: "Initializes Bluetooth and configures the plotter with the sensor name.",
  bluetooth_example3_step2: "Continuously reads the LDR sensor value on pin D39.",
  bluetooth_example3_step3: "Displays this value in the console and also sends it to the graph in the app.",
  bluetooth_example3_step4: "Repeats this process every 1 second.",
  bluetooth_example3_plotter_title: "Accessing the graph in the app",
  bluetooth_example3_plotter_access: "After running the program and connecting to the device, click the Plotter option in the Bluefruit Connect app.",
  bluetooth_example3_result_title: "Viewing results on the graph",
  bluetooth_example3_result_info: "On the graph, you can track the sensor’s value in real time. The line moves as light levels change — covering the sensor reduces the value; lighting it increases the value.",
  bluetooth_example3_plotter_controls: "The Plotter also includes controls at the bottom:",
  bluetooth_example3_autoscroll: "AutoScroll: when enabled, the graph scrolls automatically as new data arrives.",
  bluetooth_example3_width: "Width: adjusts the graph line width, useful for highlighting spikes or smoothing curves.",
